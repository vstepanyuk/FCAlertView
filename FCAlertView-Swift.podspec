#
#  Be sure to run `pod spec lint FCAlertView-Swift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "FCAlertView-Swift"
  s.version      = "1.0.0"
  s.summary      = "A simple iOS AlertView library, written in Swift."
  ...
  s.homepage     = "https://github.com/k9101/FCAlertView.git"
  #s.screenshots  = "https://github.com/nimati/FCAlertView/blob/master/Images/ScreenShots/ScreenShot.png", "https://github.com/nimati/FCAlertView/blob/master/Images/ScreenShots/ScreenShot2.png"
  ...
  s.author             = { "Kris Penney" => "hello@krispenney.me" }
  # Or just: s.author    = "k9101"
  # s.authors            = { "k9101" => "kris9101@gmail.com" }
  s.social_media_url   = "http://krispenney.me"
  ...
  s.source       = { :git => "https://github.com/k9101/FCAlertView.git", :tag => s.version.to_s }
  ...
  s.source_files  = "FCAlertView/FCAlertView/*{h,swift,png}"
